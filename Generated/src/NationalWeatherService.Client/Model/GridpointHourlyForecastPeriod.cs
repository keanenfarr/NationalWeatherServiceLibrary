...
namespace NationalWeatherService.Client.Model
{
    ...
    /// </summary>
    public partial class GridpointHourlyForecastPeriod : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GridpointHourlyForecastPeriod" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GridpointHourlyForecastPeriod {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="GridpointHourlyForecastPeriod" />
    /// </summary>
    public class GridpointHourlyForecastPeriodJsonConverter : JsonConverter<GridpointHourlyForecastPeriod>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="GridpointHourlyForecastPeriod" />
        /// </summary>
        ...
        public override GridpointHourlyForecastPeriod Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<GridpointHourlyForecastPeriod.TemperatureUnitEnum?> temperatureUnit = default;
            Option<GridpointHourlyForecastPeriod.TemperatureTrendEnum?> temperatureTrend = default;
            ...
            Option<GridpointHourlyForecastPeriod.WindDirectionEnum?> windDirection = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "temperatureUnit":
                            ...
                            if (temperatureUnitRawValue != null)
                                temperatureUnit = new Option<GridpointHourlyForecastPeriod.TemperatureUnitEnum?>(GridpointHourlyForecastPeriod.TemperatureUnitEnumFromStringOrDefault(temperatureUnitRawValue));
                            break;
                        case "temperatureTrend":
                            string? temperatureTrendRawValue = utf8JsonReader.GetString();
                            if (temperatureTrendRawValue != null)
                                temperatureTrend = new Option<GridpointHourlyForecastPeriod.TemperatureTrendEnum?>(GridpointHourlyForecastPeriod.TemperatureTrendEnumFromStringOrDefault(temperatureTrendRawValue));
                            break;
                        ...
                        case "windDirection":
                            ...
                            if (windDirectionRawValue != null)
                                windDirection = new Option<GridpointHourlyForecastPeriod.WindDirectionEnum?>(GridpointHourlyForecastPeriod.WindDirectionEnumFromStringOrDefault(windDirectionRawValue));
                            break;
                        case "icon":
            ...
            if (number.IsSet && number.Value == null)
                throw new ArgumentNullException(nameof(number), "Property is not nullable for class GridpointHourlyForecastPeriod.");

            if (name.IsSet && name.Value == null)
                throw new ArgumentNullException(nameof(name), "Property is not nullable for class GridpointHourlyForecastPeriod.");

            if (startTime.IsSet && startTime.Value == null)
                throw new ArgumentNullException(nameof(startTime), "Property is not nullable for class GridpointHourlyForecastPeriod.");

            if (endTime.IsSet && endTime.Value == null)
                throw new ArgumentNullException(nameof(endTime), "Property is not nullable for class GridpointHourlyForecastPeriod.");

            if (isDaytime.IsSet && isDaytime.Value == null)
                throw new ArgumentNullException(nameof(isDaytime), "Property is not nullable for class GridpointHourlyForecastPeriod.");

            if (temperature.IsSet && temperature.Value == null)
                throw new ArgumentNullException(nameof(temperature), "Property is not nullable for class GridpointHourlyForecastPeriod.");

            if (temperatureUnit.IsSet && temperatureUnit.Value == null)
                throw new ArgumentNullException(nameof(temperatureUnit), "Property is not nullable for class GridpointHourlyForecastPeriod.");

            if (probabilityOfPrecipitation.IsSet && probabilityOfPrecipitation.Value == null)
                throw new ArgumentNullException(nameof(probabilityOfPrecipitation), "Property is not nullable for class GridpointHourlyForecastPeriod.");

            if (dewpoint.IsSet && dewpoint.Value == null)
                throw new ArgumentNullException(nameof(dewpoint), "Property is not nullable for class GridpointHourlyForecastPeriod.");

            if (relativeHumidity.IsSet && relativeHumidity.Value == null)
                throw new ArgumentNullException(nameof(relativeHumidity), "Property is not nullable for class GridpointHourlyForecastPeriod.");

            if (windSpeed.IsSet && windSpeed.Value == null)
                throw new ArgumentNullException(nameof(windSpeed), "Property is not nullable for class GridpointHourlyForecastPeriod.");

            if (windDirection.IsSet && windDirection.Value == null)
                throw new ArgumentNullException(nameof(windDirection), "Property is not nullable for class GridpointHourlyForecastPeriod.");

            if (icon.IsSet && icon.Value == null)
                throw new ArgumentNullException(nameof(icon), "Property is not nullable for class GridpointHourlyForecastPeriod.");

            if (shortForecast.IsSet && shortForecast.Value == null)
                throw new ArgumentNullException(nameof(shortForecast), "Property is not nullable for class GridpointHourlyForecastPeriod.");

            if (detailedForecast.IsSet && detailedForecast.Value == null)
                throw new ArgumentNullException(nameof(detailedForecast), "Property is not nullable for class GridpointHourlyForecastPeriod.");

            return new GridpointHourlyForecastPeriod(number, name, startTime, endTime, isDaytime, temperature, temperatureUnit, temperatureTrend, probabilityOfPrecipitation, dewpoint, relativeHumidity, windSpeed, windGust, windDirection, icon, shortForecast, detailedForecast);
        }

        /// <summary>
        /// Serializes a <see cref="GridpointHourlyForecastPeriod" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="gridpointHourlyForecastPeriod"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, GridpointHourlyForecastPeriod gridpointHourlyForecastPeriod, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, gridpointHourlyForecastPeriod, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GridpointHourlyForecastPeriod" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="gridpointHourlyForecastPeriod"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, GridpointHourlyForecastPeriod gridpointHourlyForecastPeriod, JsonSerializerOptions jsonSerializerOptions)
        {
            if (gridpointHourlyForecastPeriod.NameOption.IsSet && gridpointHourlyForecastPeriod.Name == null)
                throw new ArgumentNullException(nameof(gridpointHourlyForecastPeriod.Name), "Property is required for class GridpointHourlyForecastPeriod.");

            if (gridpointHourlyForecastPeriod.TemperatureOption.IsSet && gridpointHourlyForecastPeriod.Temperature == null)
                throw new ArgumentNullException(nameof(gridpointHourlyForecastPeriod.Temperature), "Property is required for class GridpointHourlyForecastPeriod.");

            if (gridpointHourlyForecastPeriod.ProbabilityOfPrecipitationOption.IsSet && gridpointHourlyForecastPeriod.ProbabilityOfPrecipitation == null)
                throw new ArgumentNullException(nameof(gridpointHourlyForecastPeriod.ProbabilityOfPrecipitation), "Property is required for class GridpointHourlyForecastPeriod.");

            if (gridpointHourlyForecastPeriod.DewpointOption.IsSet && gridpointHourlyForecastPeriod.Dewpoint == null)
                throw new ArgumentNullException(nameof(gridpointHourlyForecastPeriod.Dewpoint), "Property is required for class GridpointHourlyForecastPeriod.");

            if (gridpointHourlyForecastPeriod.RelativeHumidityOption.IsSet && gridpointHourlyForecastPeriod.RelativeHumidity == null)
                throw new ArgumentNullException(nameof(gridpointHourlyForecastPeriod.RelativeHumidity), "Property is required for class GridpointHourlyForecastPeriod.");

            if (gridpointHourlyForecastPeriod.WindSpeedOption.IsSet && gridpointHourlyForecastPeriod.WindSpeed == null)
                throw new ArgumentNullException(nameof(gridpointHourlyForecastPeriod.WindSpeed), "Property is required for class GridpointHourlyForecastPeriod.");

            if (gridpointHourlyForecastPeriod.IconOption.IsSet && gridpointHourlyForecastPeriod.Icon == null)
                throw new ArgumentNullException(nameof(gridpointHourlyForecastPeriod.Icon), "Property is required for class GridpointHourlyForecastPeriod.");

            if (gridpointHourlyForecastPeriod.ShortForecastOption.IsSet && gridpointHourlyForecastPeriod.ShortForecast == null)
                throw new ArgumentNullException(nameof(gridpointHourlyForecastPeriod.ShortForecast), "Property is required for class GridpointHourlyForecastPeriod.");

            if (gridpointHourlyForecastPeriod.DetailedForecastOption.IsSet && gridpointHourlyForecastPeriod.DetailedForecast == null)
                throw new ArgumentNullException(nameof(gridpointHourlyForecastPeriod.DetailedForecast), "Property is required for class GridpointHourlyForecastPeriod.");

            if (gridpointHourlyForecastPeriod.NumberOption.IsSet)
                writer.WriteNumber("number", gridpointHourlyForecastPeriod.NumberOption.Value!.Value);

            if (gridpointHourlyForecastPeriod.NameOption.IsSet)
                writer.WriteString("name", gridpointHourlyForecastPeriod.Name);

            if (gridpointHourlyForecastPeriod.StartTimeOption.IsSet)
                writer.WriteString("startTime", gridpointHourlyForecastPeriod.StartTimeOption.Value!.Value.ToString(StartTimeFormat));

            if (gridpointHourlyForecastPeriod.EndTimeOption.IsSet)
                writer.WriteString("endTime", gridpointHourlyForecastPeriod.EndTimeOption.Value!.Value.ToString(EndTimeFormat));

            if (gridpointHourlyForecastPeriod.IsDaytimeOption.IsSet)
                writer.WriteBoolean("isDaytime", gridpointHourlyForecastPeriod.IsDaytimeOption.Value!.Value);

            if (gridpointHourlyForecastPeriod.TemperatureOption.IsSet)
            {
                writer.WritePropertyName("temperature");
                JsonSerializer.Serialize(writer, gridpointHourlyForecastPeriod.Temperature, jsonSerializerOptions);
            }
            var temperatureUnitRawValue = GridpointHourlyForecastPeriod.TemperatureUnitEnumToJsonValue(gridpointHourlyForecastPeriod.TemperatureUnitOption.Value!.Value);
            writer.WriteString("temperatureUnit", temperatureUnitRawValue);
            var temperatureTrendRawValue = GridpointHourlyForecastPeriod.TemperatureTrendEnumToJsonValue(gridpointHourlyForecastPeriod.TemperatureTrendOption.Value!.Value);
            if (temperatureTrendRawValue != null)
                writer.WriteString("temperatureTrend", temperatureTrendRawValue);
            else
                writer.WriteNull("temperatureTrend");

            if (gridpointHourlyForecastPeriod.ProbabilityOfPrecipitationOption.IsSet)
            {
                writer.WritePropertyName("probabilityOfPrecipitation");
                JsonSerializer.Serialize(writer, gridpointHourlyForecastPeriod.ProbabilityOfPrecipitation, jsonSerializerOptions);
            }
            if (gridpointHourlyForecastPeriod.DewpointOption.IsSet)
            {
                writer.WritePropertyName("dewpoint");
                JsonSerializer.Serialize(writer, gridpointHourlyForecastPeriod.Dewpoint, jsonSerializerOptions);
            }
            if (gridpointHourlyForecastPeriod.RelativeHumidityOption.IsSet)
            {
                writer.WritePropertyName("relativeHumidity");
                JsonSerializer.Serialize(writer, gridpointHourlyForecastPeriod.RelativeHumidity, jsonSerializerOptions);
            }
            if (gridpointHourlyForecastPeriod.WindSpeedOption.IsSet)
            {
                writer.WritePropertyName("windSpeed");
                JsonSerializer.Serialize(writer, gridpointHourlyForecastPeriod.WindSpeed, jsonSerializerOptions);
            }
            if (gridpointHourlyForecastPeriod.WindGustOption.IsSet)
                if (gridpointHourlyForecastPeriod.WindGustOption.Value != null)
                {
                    writer.WritePropertyName("windGust");
                    JsonSerializer.Serialize(writer, gridpointHourlyForecastPeriod.WindGust, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("windGust");
            var windDirectionRawValue = GridpointHourlyForecastPeriod.WindDirectionEnumToJsonValue(gridpointHourlyForecastPeriod.WindDirectionOption.Value!.Value);
            writer.WriteString("windDirection", windDirectionRawValue);
            if (gridpointHourlyForecastPeriod.IconOption.IsSet)
                writer.WriteString("icon", gridpointHourlyForecastPeriod.Icon);

            if (gridpointHourlyForecastPeriod.ShortForecastOption.IsSet)
                writer.WriteString("shortForecast", gridpointHourlyForecastPeriod.ShortForecast);

            if (gridpointHourlyForecastPeriod.DetailedForecastOption.IsSet)
                writer.WriteString("detailedForecast", gridpointHourlyForecastPeriod.DetailedForecast);
        }
    }
}
