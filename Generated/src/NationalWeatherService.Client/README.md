...
inputSpec: /workspace/OpenApi/openApi.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{AC4DDC09-D284-4FD1-B30D-E3EF83E1CF65}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IAlertsActiveApiResponse apiResponse = await api.AlertsActiveAsync("todo");
            AlertCollectionGeoJson? model = apiResponse.Ok();
        }
...
## Api Information
- appName: weather.gov API
- appVersion: 2.6.0
- appDescription: weather.gov API
